# Date Detector
Scans images for dates and compares them with the current date. If all of the dates in the image are before the current date, the program will print invalid. If any of the dates are after the current date, the program will print valid. 
